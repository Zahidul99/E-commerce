...
class ProductController extends Controller
{
    ...
    public function save_product(Request $request)
    {
       ...
       $data['product-weight']=$request->product_weight;
   ...
   return Redirect::to('/all-product');
    ...
    ->first();
     ...
     $all_product_info=view('edit_product')
         ->with('all_product_info',$all_product_info);

         return view('admin_layout')
         ->with('edit_product',$all_product_info);
       ...
       if ($image) {
        ...
        if ($success) {
          $data['product_image']=$image_url;
             ...
             ->where('product_id',$product_id)
              ->update($data);
               Session::put('messege','Product Update successfully !!');
               return Redirect::to('/all-product');
             }
           }
          ...
          Session::put('messege','Product Update successfully without image!!');
                return Redirect::to('/all-product'); 
