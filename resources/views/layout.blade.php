...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +8801757289942</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> ferdosrony99@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-md-4 clearfix">
						<div class="logo pull-left">
							<a href="{{URL::to('/')}}"><img src="{{URL::to('frontend/images/home/beatnik.jpg')}}" alt="" /></a>
						</div>
					</div>
					...
					<div class="left-sidebar">
						...
						<div class="price-range"><!--price-range-->
							...
							<div class="well text-center">
								 <input type="text" class="span2" value="" data-slider-min="100" data-slider-max="200000" data-slider-step="5" data-slider-value="[100,200000]" id="sl2" ><br />
								 <b class="pull-left">Tk 100</b> <b class="pull-right">Tk 200000</b>
							</div>
						</div><!--/price-range-->
	...
	<footer id="footer"><!--Footer-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							<h2>beatnik</h2>
							<p>You can see all of delevery people are here</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-center">Copyright © 2020 all rights reserved by Beatnik Technology</p>
